...
/**
 * Created by Hanle on 10/27/2016.
 */
...
public class ListOfCancelledEvent extends AppCompatActivity {
    private List<CancelledEventView> feedsList = new ArrayList<CancelledEventView>();
    private RecyclerView mRecyclerView;
    private CancelledEventViewAdapter adapter;
    Context ctx;
    private AlertDialog progressDialog;
    TextView t;
    String event_id, mobileno, countrycode;
    private static final String TAG = "ListOfCancelled";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (ConnectionDetector.isInternetAvailable(ListOfCancelledEvent.this)) {
    ...
    public class AsyncHttpTask extends AsyncTask<String, Void, Integer> {
        ...
        protected void onPreExecute() {
            progressDialog = new ProgressDialog(ListOfCancelledEvent.this);
        ...
        protected void onPostExecute(Integer result) {
            ...
            if (result == 1) {
                adapter = new CancelledEventViewAdapter(ListOfCancelledEvent.this, feedsList);
                mRecyclerView.setAdapter(adapter);
                progressDialog.hide();

            } else {
                progressDialog.hide();
                Toast.makeText(ListOfCancelledEvent.this, "Failed to fetch data!", Toast.LENGTH_SHORT).show();
            }
        }
    }
    ...
    private void parseResult(String result) {
        try {
            ...
            System.out.println("TAG:" + response);
                ...
                CancelledEventView item = new CancelledEventView();
