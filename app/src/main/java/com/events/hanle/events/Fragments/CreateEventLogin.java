...
/**
 * Created by Hanle on 11/14/2017.
 */

public class CreateEventLogin extends DialogFragment {
    private TextView t;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.dialog_login_create_event, container, false);
