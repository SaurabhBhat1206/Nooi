...
public class WebUrl {
  ...
  // public final static String ORGANISER_URL = "http://nooitheinviteapp.com/mobile/organiser_mobile/mobile/";
    ...
    //me loki testing
   public final static String BASE_URL = "http://uat.hanlesolutions.com/mobiletest/event_mobile_webservices/phpscript";
   public final static String ORGANISER_URL = "http://uat.hanlesolutions.com/mobiletest/mobile/";

    //beta testing
   // public static final String BASE_URL = "http://uat.hanlesolutions.com/beta/event_mobile_webservices/phpscript";
   // public final static String ORGANISER_URL = "http://uat.hanlesolutions.com/beta/mobile/mobile/";
    ...
    public final static String USER_ATTENDING_NEW = ORGANISER_URL + "user/user_response_for_events";
    ...
    public final static String CANCELLED_EVENT = ORGANISER_URL + "event/list_of_cancelled_Event?countrycode=COUNTRY_CODE&phone=_USERID_";
    public final static String CONCLUDED_EVENT = ORGANISER_URL + "event/list_of_concluded_Event?countrycode=COUNTRY_CODE&phone=_USERID_";
    ...
    public final static String GETGALLERYIMAGES = ORGANISER_URL+ "event/getnooiImages?eventId=EVENT_ID";
    public final static String BANNERIMAGES = ORGANISER_URL+ "event/getbannerimages";
