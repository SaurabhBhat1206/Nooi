...
/**
 * Created by Hanle on 8/29/2017.
 */

public class ConcludedEvent extends AppCompatActivity {
    CompletedEventAdapter adapter;
    RecyclerView rv;
    private List<CompletedEvent> completedevent = new ArrayList<>();
    Context ctx;
    private String TAG = ConcludedEvent.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new CompletedEventAdapter(getApplicationContext(), completedevent);
    ...
    private void fetchcompletedddata() {
        String endpoint = WebUrl.CONCLUDED_EVENT.replace("COUNTRY_CODE", countrycode);
