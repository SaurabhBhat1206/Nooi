...
public class EndPoints
{
  ...
  // public static final String BASE_URL = "http://www.nooitheinviteapp.com/newchat/gcm_chat/v1/index.php";
   ...
   public static final String BASE_URL = "http://uat.hanlesolutions.com/mobiletest/newchat/gcm_chat/v1/index.php";
    //beta testing
    //public static final String BASE_URL = "http://uat.hanlesolutions.com/beta/newchat/gcm_chat/v1/index.php";
